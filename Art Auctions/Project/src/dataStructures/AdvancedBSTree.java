...
public abstract class AdvancedBSTree<K extends Comparable<K>, V> extends BinarySearchTree<K,V> {
     ...
     */
    protected BSTNode<K,V> minNode( BSTNode<K,V> theRoot, Stack<PathStep<K,V>> path ){
     ...
     */
    protected void rotateLeft( BSTNode<K,V> theRoot, BSTNode<K,V> leftChild, Stack<PathStep<K,V>> path ) {
     ...
     * @param path - Stack of PathStep objects containing all ancestors of theRoot 
     */
    protected void rotateRight( BSTNode<K,V> theRoot, BSTNode<K,V> rightChild, Stack<PathStep<K,V>> path ) {
     ...
     * @param path - Stack of PathStep objects containing all ancestors of theRoot
     */
    protected void rotateLeft( BSTNode<K,V> theRoot, BSTNode<K,V> leftChild, BSTNode<K,V> rightGrandchild, Stack<PathStep<K,V>> path ) {
